...
function Library:CreateWindow(config)
    ...
    -- 2. MAIN FRAME (TÔNG ĐEN CHỦ ĐẠO)
    local Main = Instance.new("Frame", ScreenGui)
    Main.BackgroundColor3 = Color3.fromRGB(5, 5, 5) -- Đen đậm
    ...
    function Window:CreateTab(name)
        ...
        TBtn.Text = name; TBtn.TextColor3 = Color3.fromRGB(255, 255, 255) -- Chữ trắng
        ...
        local function CreateColumn(pos)
            ...
            Col.BackgroundColor3 = Color3.fromRGB(15, 15, 15) -- Cột đen nhạt
        ...
        function Tab:CreateSection(title, side)
            ...
            sTitle.Font = Enum.Font.GothamBold; sTitle.TextSize = 16
            ...
            L:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
                Sec.Size = UDim2.new(0.94, 0, 0, L.AbsoluteContentSize.Y + 45)
            ...
            function Ele:CreateToggle(text, def, cb)
                ...
                Check.TextColor3 = Color3.fromRGB(255, 255, 255); Check.Visible = state
                Check.Font = Enum.Font.GothamBold; Check.TextSize = 15
