...
function Library:CreateWindow(cfg)
    ...
    Instance.new("UIListLayout", TabScroll).Padding = UDim.new(0, 8); Instance.new("UIListLayout", TabScroll).VerticalAlignment = "Center"
    ...
    function Window:CreateTab(name)
        ...
        function Tab:CreateSection(title, side)
            ...
            Sec.BackgroundColor3 = Color3.fromRGB(18, 18, 18); Instance.new("UICorner", Sec).CornerRadius = UDim.new(0, 10)
            ...
            function Ele:AddToggle(text, cb)
                ...
                local Circle = Instance.new("Frame", Tgl); Circle.Size = UDim2.new(0, 22, 0, 22); Circle.Position = UDim2.new(1, -30, 0.5, -11)
