    ...
    function Window:CreateTab(name)
        ...
        function Tab:CreateSection(title, side)
            ...
            function Ele:AddToggle(text, cb)
                ...
                TglBtn.Text = "  " .. text; TglBtn.TextColor3 = Color3.fromRGB(200, 200, 200); TglBtn.TextXAlignment = "Left"; Instance.new("UICorner", TglBtn)
            ...
            function Ele:AddButton(text, cb)
                ...
                B.Text = text; B.TextColor3 = Color3.fromRGB(255, 255, 255); Instance.new("UICorner", B); B.MouseButton1Click:Connect(cb)
            end
            return Ele
        end
        return Tab
