...
function Library:CreateWindow(cfg)
    ...
    -- [ 2. FIX LOGO TRONG MENU: LUÔN TRÊN CÙNG ]
    ...
    function Window:CreateTab(name)
        ...
        -- [ 3. FIX HIỆN SECTION: ÉP CANVAS SIZE CẬP NHẬT ]
        local function CreateCol(pos)
            ...
            -- Ép cột luôn nở ra theo nội dung
        ...
        function Tab:CreateSection(title, side)
            ...
            -- [ 4. FIX SECTITLE: LUÔN Ở TRÊN CÙNG ]
            ...
            function Ele:AddDropdown(text, list, cb)
                ...
                local SFrame = Instance.new("ScrollingFrame", Drop); SFrame.Position = UDim2.new(0, 0, 0, 32); SFrame.Size = UDim2.new(1, 0, 0, 100); SFrame.BackgroundTransparency = 1; SFrame.ScrollBarThickness = 0; SFrame.CanvasSize = UDim2.new(0, 0, 0, 0)
                ...
                for _, v in pairs(list) do
                    ...
                    Item.MouseButton1Click:Connect(function()
                        Btn.Text = "  "..text.." : "..v; isOpened = false; TweenService:Create(Drop, TweenInfo.new(0.3), {Size = UDim2.new(1, -20, 0, 32)}):Play(); cb(v)
                    end)
                end
            end
            return Ele
