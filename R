...
function Library:CreateWindow(cfg)
    ...
    InnerLogo.ZIndex = 10; InnerLogo.Image = "rbxassetid://"..(cfg.Logo or "107831103893115")
    Instance.new("UICorner", InnerLogo).CornerRadius = UDim.new(0, 8)

    -- Thanh Tab Bar
    local TabBar = Instance.new("Frame", Main)
    TabBar.Size = UDim2.new(1, -110, 0, 40); TabBar.Position = UDim2.new(0, 60, 0, 10)
    ...
    TabLY.HorizontalAlignment = "Center" -- Đưa các Tab vào chính giữa

    local CloseBtn = Instance.new("TextButton", Main)
    CloseBtn.Size = UDim2.new(0, 30, 0, 30); CloseBtn.Position = UDim2.new(1, -35, 0, 15)
    CloseBtn.Text = "×"; CloseBtn.TextColor3 = Color3.fromRGB(255, 80, 80); CloseBtn.BackgroundTransparency = 1; CloseBtn.TextSize = 28; CloseBtn.Font = "GothamBold"; CloseBtn.ZIndex = 11
    ...
    function Window:CreateTab(name)
        ...
        local Page = Instance.new("Frame", Container); Page.Size = UDim2.new(1, 0, 1, 0); Page.Visible = false; Page.BackgroundTransparency = 1; Page.ZIndex = 5
        ...
        local function CreateCol(pos)
            ...
            -- Cập nhật CanvasSize liên tục để không bị mất Section
        ...
        function Tab:CreateSection(title, side)
            ...
            Sec.BackgroundColor3 = Color3.fromRGB(18, 18, 18); Sec.Size = UDim2.new(1, 0, 0, 45)
            ...
            Instance.new("UIPadding", Sec).PaddingTop = UDim.new(0, 8); Instance.new("UIPadding", Sec).PaddingBottom = UDim.new(0, 10)
            ...
            SecTitle.TextColor3 = Color3.fromRGB(255, 255, 255); SecTitle.Font = "GothamBold"; SecTitle.TextSize = 12; SecTitle.LayoutOrder = -100
            ...
            function Ele:AddToggle(text, cb)
                ...
                local Box = Instance.new("Frame", Tgl); Box.Size = UDim2.new(0, 20, 0, 20); Box.Position = UDim2.new(1, -25, 0.5, -10); Box.BackgroundColor3 = Color3.fromRGB(45, 45, 45); Instance.new("UICorner", Box).CornerRadius = UDim.new(0, 5)
